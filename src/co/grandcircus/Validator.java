...
public class Validator {
	...
	public static String getValidOpponent(Scanner scnr, String prompt, String regex) {
		boolean isValid = false;
		String input;
		do {
			input = getString(scnr, prompt);
			...
			if (input.matches(regex)) {
				...
				System.out.println("Sorry. You must choose B for RockOrBust, or R for Random.");
				isValid = false;
			}
	...
	public static String getValidRPS(Scanner scnr, String prompt, String regex) {
		boolean isValid = false;
		String input;
		do {
			input = getString(scnr, prompt);
			...
			if (input.matches(regex)) {
				...
				System.out.println("Sorry. You must choose R for Rock, P for Paper, or S for Scissors.");
				isValid = false;
			}
	...
	public static String getValidContinue(Scanner scnr, String prompt, String regex) {
		boolean isValid = false;
		String input;
		do {
			input = getString(scnr, prompt);
			...
			if (input.matches(regex)) {
				...
				System.out.println("Sorry. You must choose Y for Yes, or N for No.");
				isValid = false;
			}
